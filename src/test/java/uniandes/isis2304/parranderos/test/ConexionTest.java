...
//			System.out.println (msg);
	 ...
	 * alguna de las siguientes causas: 1. No existe la unidad de persistencia 2. La
	 * unidad de persistencia está caida
	 */
	@Test
...
//			e.printStackTrace();
	...
	/**
	 * Método que prueba el intento de acceso a una base de datos inaccesible, por
	 * causa: 1. Credenciales de usuario inválidas (nombre de usuario / contraseña)
	 */
	@Test
...
//			e.printStackTrace();
	...
	/**
	 * Método que prueba el intento de acceso a una base de datos inaccesible, por
	 * causa: 1. El esquema no ha sido creado o es erróneo - Intentar acceder a una
	 * tabla inexistente
	 */
	@Test
