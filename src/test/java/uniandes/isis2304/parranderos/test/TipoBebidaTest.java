...
public class TipoBebidaTest {
	...
	/*
	 * **************************************************************** Métodos de
	 * prueba para la tabla TipoBebida - Creación y borrado
	 *****************************************************************/
	/**
	 * Método que prueba las operaciones sobre la tabla TipoBebida 1. Adicionar un
	 * tipo de bebida 2. Listar el contenido de la tabla con 0, 1 y 2 registros
	 * insertados 3. Borrar un tipo de bebida por su identificador 4. Borrar un tipo
	 * de bebida por su nombre
	 */
	@Test
...
//			e.printStackTrace();
		...
		try {
			...
			assertTrue("El primer tipo de bebida adicionado debe estar en la tabla",
					tipoBebida1.equals(lista.get(0)) || tipoBebida1.equals(lista.get(1)));
			assertTrue("El segundo tipo de bebida adicionado debe estar en la tabla",
					tipoBebida2.equals(lista.get(0)) || tipoBebida2.equals(lista.get(1)));
			...
			assertFalse("El primer tipo de bebida adicionado NO debe estar en la tabla",
					tipoBebida1.equals(lista.get(0)));
...
//			e.printStackTrace();
			log.info(
					"Prueba de UNICIDAD de Tipobebida incompleta. No se pudo conectar a la base de datos !!. La excepción generada es: "
							+ e.getClass().getName());
			log.info("La causa es: " + e.getCause().toString());
