...
//			e.printStackTrace();
	 ...
	 *****************************************************************/
	/**
	 * Demostración de creación, consulta y borrado de Bebidas. Incluye también los
	 * tipos de bebida pues el tipo de bebida es llave foránea en las bebidas
...
//			e.printStackTrace();
	...
	/**
	 * Demostración de creación y borrado de bebidas no servidas. Incluye también
	 * los tipos de bebida pues el tipo de bebida es llave foránea en las bebidas
	 * Caso 1: Ninguna bebida es servida en ningún bar: La tabla de bebidas queda
	 * vacía antes de la fase de limpieza Muestra la traza de la ejecución en el
	 * panelDatos
	 * 
	 * Pre: La base de datos está vacía Post: La base de datos está vacía
	 */
...
//			e.printStackTrace();
	 ...
	 * Demostración de creación y borrado de bebidas no servidas. Incluye también
	 * los tipos de bebida pues el tipo de bebida es llave foránea en las bebidas
	 * Incluye también los bares pues son llave foránea en la relación Sirven Caso
	 * 2: Hay bebidas que son servidas y estas quedan en la tabla de bebidas Muestra
	 * la traza de la ejecución en el panelDatos
	 * 
	 * Pre: La base de datos está vacía Post: La base de datos está vacía
	 */
...
//			e.printStackTrace();
	 ...
	 *****************************************************************/
	/**
	 * Demostración de creación, consulta y borrado de Bares Muestra la traza de la
	 * ejecución en el panelDatos
	 * 
	 * Pre: La base de datos está vacía Post: La base de datos está vacía
	 */
	public void demoBar() {
...
//			e.printStackTrace();
	...
	/**
	 * Demostración de la consulta: Dar el id y el número de bebidas que sirve cada
	 * bar, siempre y cuando el bar sirva por los menos una bebida Incluye el manejo
	 * de los tipos de bebida pues el tipo de bebida es llave foránea en las bebidas
	 * Incluye el manajo de las bebidas Incluye el manejo de los bares Incluye el
	 * manejo de la relación sirven Muestra la traza de la ejecución en el
	 * panelDatos
	 * 
	 * Pre: La base de datos está vacía Post: La base de datos está vacía
	 */
...
//			e.printStackTrace();
	...
	/**
	 * Demostración de la modificación: Aumentar en uno el número de sedes de los
	 * bares de una ciudad Muestra la traza de la ejecución en el panelDatos
	 * 
	 * Pre: La base de datos está vacía Post: La base de datos está vacía
	 */
...
//			e.printStackTrace();
	 ...
	 *****************************************************************/
	/**
	 * Demostración de creación, consulta y borrado de Bebedores Incluye la consulta
	 * por nombre y por id Incluye el borrado por nombre Muestra la traza de la
	 * ejecución en el panelDatos
	 * 
	 * Pre: La base de datos está vacía Post: La base de datos está vacía
	 */
...
//			e.printStackTrace();
	...
	/**
	 * Demostración de creación, consulta de TODA LA INFORMACIÖN de un bebedor y
	 * borrado de un bebedor y sus visitas Incluye el manejo de tipos de bebida
	 * Incluye el manejo de bebidas Incluye el manejo de bares Incluye el manejo de
	 * la relación sirven Incluye el manejo de la relación gustan Incluye el borrado
	 * de un bebedor y todas sus visitas Muestra la traza de la ejecución en el
	 * panelDatos
	 * 
	 * Pre: La base de datos está vacía Post: La base de datos está vacía
	 */
	public void demoDarBebedorCompleto() {
		try {
			...
			parranderos.adicionarVisitan(bdor1.getId(), bar1.getId(), new Timestamp(System.currentTimeMillis()),
					"diurno");
			parranderos.adicionarVisitan(bdor1.getId(), bar1.getId(), new Timestamp(System.currentTimeMillis()),
					"nocturno");
			parranderos.adicionarVisitan(bdor1.getId(), bar1.getId(), new Timestamp(System.currentTimeMillis()),
			...
			resultado += bebedorVisitasEliminados[0] + " Bebedores eliminados y " + bebedorVisitasEliminados[1]
					+ " Visitas eliminadas\n";
			resultado += baresEliminados + " Bares eliminados\n";
			resultado += "\n Demo terminada";
...
//			e.printStackTrace();
	...
	/**
	 * Demostración de creación, consulta de TODA LA INFORMACIÖN de un bebedor y
	 * borrado de un bebedor y sus visitas. Si hay posibilidades de alguna
	 * incoherencia con esta operación NO SE BORRA NI EL BEBEDOR NI SUS VISITAS
	 * Incluye el manejo de tipos de bebida Incluye el manejo de bebidas Incluye el
	 * manejo de bares Incluye el manejo de la relación sirven Incluye el manejo de
	 * la relación gustan Incluye el borrado de un bebedor y todas sus visitas v1
	 * Muestra la traza de la ejecución en el panelDatos
	 * 
	 * Pre: La base de datos está vacía Post: La base de datos queda con las tuplas
	 * que no se pudieron borrar: ES COHERENTE DE TODAS MANERAS
	 */
	public void demoEliminarBebedorYVisitas_v1() {
		try {
			...
			// No se elimina la tupla de GUSTAN para estudiar la coherencia de las
			// operaciones en la base de daatos
...
//			e.printStackTrace();
	 ...
	 * Demostración de creación, consulta de TODA LA INFORMACIÖN de un bebedor y
	 * borrado de un bebedor y sus visitas Si hay posibilidades de alguna
	 * incoherencia con esta operación SE BORRA LO AQUELLO QUE SEA POSIBLE, PERO
	 * CONSERVANDO LA COHERENCIA DE LA BASE DE DATOS Incluye el manejo de tipos de
	 * bebida Incluye el manejo de bebidas Incluye el manejo de bares Incluye el
	 * manejo de la relación sirven Incluye el manejo de la relación gustan Incluye
	 * el borrado de un bebedor y todas sus visitas v2 Muestra la traza de la
	 * ejecución en el panelDatos
	 * 
	 * Pre: La base de datos está vacía Post: La base de datos queda con las tuplas
	 * que no se pudieron borrar
	 */
...
//			e.printStackTrace();
	...
	/**
	 * Demostración de la modificación: Cambiar la ciudad de un bebedor Muestra la
	 * traza de la ejecución en el panelDatos
	 * 
	 * Pre: La base de datos está vacía Post: La base de datos está vacía
	 */
...
//			e.printStackTrace();
	...
	/**
	 * Demostración de la consulta: Dar la información de los bebedores y del número
	 * de bares que visita cada uno Incluye el manejo de los bares Incuye el manejo
	 * de la relación visitan Muestra la traza de la ejecución en el panelDatos
	 * 
	 * Pre: La base de datos está vacía Post: La base de datos está vacía
	 */
	public void demoBebedoresYNumVisitasRealizadas() {
		try {
			...
			parranderos.adicionarVisitan(bdor1.getId(), bar1.getId(), new Timestamp(System.currentTimeMillis()),
					"todos");
			parranderos.adicionarVisitan(bdor1.getId(), bar2.getId(), new Timestamp(System.currentTimeMillis()),
					"diurno");
			parranderos.adicionarVisitan(bdor1.getId(), bar3.getId(), new Timestamp(System.currentTimeMillis()),
					"diurno");
			parranderos.adicionarVisitan(bdor2.getId(), bar3.getId(), new Timestamp(System.currentTimeMillis()),
					"diurno");
			parranderos.adicionarVisitan(bdor2.getId(), bar4.getId(), new Timestamp(System.currentTimeMillis()),
					"diurno");
...
//			e.printStackTrace();
	 ...
	 * Incluye el manejo de bares Incluye el manejo de la relación visitan Muestra
	 * la traza de la ejecución en el panelDatos
	 * 
	 * Pre: La base de datos está vacía Post: La base de datos está vacía
	 */
	public void demoBebedoresDeCiudad() {
		try {
			...
			parranderos.adicionarVisitan(bdor2.getId(), bar3.getId(), new Timestamp(System.currentTimeMillis()),
					"diurno");
			parranderos.adicionarVisitan(bdor1.getId(), bar4.getId(), new Timestamp(System.currentTimeMillis()),
					"diurno");
...
//			e.printStackTrace();
	 ...
	 *****************************************************************/
	/**
	 * Demostración de creación, consulta y borrado de la relación Gustan Incluye el
	 * manejo de Bebedores Incluye el manejo de Bebidas Muestra la traza de la
	 * ejecución en el panelDatos
	 * 
	 * Pre: La base de datos está vacía Post: La base de datos está vacía
	 */
...
//			e.printStackTrace();
	 ...
	 *****************************************************************/
	/**
	 * Demostración de creación, consulta y borrado de la relación Sirven Incluye el
	 * manejo de Bares Incluye el manejo de tipos de bebida Incluye el manejo de
	 * Bebidas Muestra la traza de la ejecución en el panelDatos
	 * 
	 * Pre: La base de datos está vacía Post: La base de datos está vacía
	 */
...
//			e.printStackTrace();
	 ...
	 *****************************************************************/
	/**
	 * Demostración de creación, consulta y borrado de la relación Visitan Incluye
	 * el manejo de Bebedores Incluye el manejo de Bares Muestra la traza de la
	 * ejecución en el panelDatos
	 * 
	 * Pre: La base de datos está vacía Post: La base de datos está vacía
	 */
...
//			e.printStackTrace();
	...
	public void limpiarBD() {
		try {
			// Ejecución de la demo y recolección de los resultados
			long eliminados[] = parranderos.limpiarEPSAndes();
...
//			e.printStackTrace();
	...
	/**
	 * Genera una cadena de caracteres con la lista de bebidas recibida: una línea
	 * por cada bebida
	 * 
	...
	/**
	 * Genera una cadena de caracteres con la lista de bebedores recibida: una línea
	 * por cada bebedor
	 * 
	...
	/**
	 * Genera una cadena de caracteres con la lista de bares recibida: una línea por
	 * cada bar
	 * 
	...
	/**
	 * Genera una cadena de caracteres con la lista de gustan recibida: una línea
	 * por cada gusta
	 * 
	...
	/**
	 * Genera una cadena de caracteres con la lista de sirven recibida: una línea
	 * por cada sirven
	 * 
	...
	/**
	 * Genera una cadena de caracteres con la lista de visitan recibida: una línea
	 * por cada visitan
	 * 
	...
	/**
	 * Genera una cadena de caracteres con la lista de parejas de números recibida:
	 * una línea por cada pareja
	 * 
	...
	/**
	 * Genera una cadena de caracteres con la lista de parejas de objetos recibida:
	 * una línea por cada pareja
	 * 
