...
public class Bebedor implements VOBebedor {
	...
	/**
	 * Las visitas realizadas por el bebedor. Cada visita es una tripleta de objetos
	 * [Bar, Timestamp, String], que representan el bar, la fecha y el horario en
	 * que el bebedor realizó la visita
	 */
	private List<Object[]> visitasRealizadas;

	/**
	 * Las bebidas que le gustan el bebedor. Cada visita es una pareja de objetos
	 * [Bebida, String], que representan la bebida y el nombre del tipo de bebida
	 * que le gustan al bebedor
	 */
	...
	/**
	 * @param bebidasQueLeGustan - La nueva lista de bebidas que le gustan al
	 *                           bebedor
	 */
	 ...
	 *         Además de la información básica, contiene las visitas realizadas (una
	 *         por línea) y las bebidas que le gustan al bebedor (una por línea)
	 */
