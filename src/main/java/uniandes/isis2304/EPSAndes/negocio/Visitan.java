...
/**
 * Clase para modelar la relación VISITAN del negocio de los Parranderos: Cada
 * objeto de esta clase representa el hecho que un bebedor visitó un bar y
 * viceversa. Se modela mediante los identificadores del bebedor y del bar
 * respectivamente Debe existir un bebedor con el identificador dado Debe
 * existir un bar con el identificador dado Adicionalmente contiene la fecha y
 * el horario (DIURNO, NOCTURNO, TODOS) en el cual el bebedor visitó el bar
 * 
 * @author Germán Bravo
 */
public class Visitan implements VOVisitan {
	 ...
	 * 
	 * @param idBebedor   - El identificador del b ebedor. Debe existir un bebedor
	 ...
	 * @param horario     - El horario en el que el bebedor vista el bar (DIURNO,
	 *                    NOCTURNO, TODOS)
	 */
	...
	/**
	 * @param idBebedor - El nuevo idBebedor. Debe existir un bebedor con dicho
	 *                  identificador
	 */
	...
	/**
	 * @param horario - El nuevo horario en que se realizó la visita (DIURNO,
	 *                NOCTURNO, TODOS)
	 */
