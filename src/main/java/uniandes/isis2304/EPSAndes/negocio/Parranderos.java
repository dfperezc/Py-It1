...
public class Parranderos {
	 ...
	 *****************************************************************/
	/**
	 * Adiciona de manera persistente una bebida Adiciona entradas al log de la
	 * aplicación
	 * 
	 * @param nombre       - El nombre la bebida
	 * @param idTipoBebida - El identificador del tipo de bebida de la bebida - Debe
	 *                     existir un TIPOBEBIDA con este identificador
	...
	/**
	 * Elimina una bebida por su nombre Adiciona entradas al log de la aplicación
	 * 
	...
	/**
	 * Elimina una bebida por su identificador Adiciona entradas al log de la
	 * aplicación
	 * 
	...
	/**
	 * Encuentra todas las bebida en Parranderos Adiciona entradas al log de la
	 * aplicación
	 * 
	 * @return Una lista de objetos Bebida con todos las bebidas que conoce la
	 ...
	 * lista de VOTipoBebida Adiciona entradas al log de la aplicación
	 * 
	 * @return Una lista de objetos VOBebida con todos las bebidas que conoce la
	 *         aplicación, llenos con su información básica
	 */
	...
	/**
	 * Elimina las bebidas que no son servidas en ningún bar (No son referenciadas
	 * en ninguna tupla de SIRVEN) Adiciona entradas al log de la aplicación
	 * 
	...
	/**
	 * Adiciona de manera persistente un bebedor Adiciona entradas al log de la
	 * aplicación
	 * 
	...
	/**
	 * Elimina un bebedor por su nombre Adiciona entradas al log de la aplicación
	 * 
	...
	/**
	 * Elimina un bebedor por su identificador Adiciona entradas al log de la
	 * aplicación
	 * 
	 ...
	 * @return Un objeto Bebedor que corresponde con el identificador buscado y
	 *         lleno con su información básica null, si un bebedor con dicho
	 ...
	 * @return Una lista de Bebedores con su información básica, donde todos tienen
	 *         el nombre buscado. La lista vacía indica que no existen bebedores con
	 *         ese nombre
	 */
	...
	/**
	 * Encuentra la información básica de los bebedores, según su nombre y los
	 * devuelve como VO
	 * 
	 * @param nombre - El nombre de bebedor a buscar
	 * @return Una lista de Bebedores con su información básica, donde todos tienen
	...
	/**
	 * Encuentra un bebedor, su información básica y los bares y las bebidas con las
	 * que está directamente relacionado, según su identificador
	 * 
	 * @param idBebedor - El identificador del bebedor buscado
	 * @return Un objeto Bebedor que corresponde con el identificador buscado y
	 *         lleno con su información básica y los bares y bebidas con los que
	...
	/**
	 * Encuentra todos los bebedores en Parranderos Adiciona entradas al log de la
	 * aplicación
	 * 
	 * @return Una lista de objetos Bebedor con todos las bebedores que conoce la
	 *         aplicación, llenos con su información básica
	 */
	 ...
	 * 
	 * @return Una lista de objetos VOBebedor con todos las bebedores que conoce la
	 *         aplicación, llenos con su información básica
	 */
	...
	/**
	 * Encuentra todos los bebedores que conoce la aplicación y el número visitas
	 * realizadas por cada uno Adiciona entradas al log de la aplicación
	 * 
	...
	/**
	 * Dado el nombre de una ciudad, encuentra el número de bebedores de esa ciudad
	 * que han realizado por lo menos una visita a un bar Adiciona entradas al log
	 * de la aplicación
	 * 
	 * @param ciudad - La ciudad de interés
	 * @return Un número que representa el número de bebedores de esa ciudad que hab
	 *         realizado por lo menos una visita a un bar
	 */
	...
	/**
	 * Cambia la ciudad de un bebedor dado su identificador Adiciona entradas al log
	 * de la aplicación
	 * 
	 * @param idBebedor - El identificador del bebedor que va a cambiar de ciudad
	 * @param ciudad    - La nueva ciudad del bebedor
	 * @return El número de tuplas modificadas: 1 o 0. 0 significa que un bebedor
	 *         con ese identificador no existe
	 */
	...
	/**
	 * Elimina un bebedor y las visitas a bares que haya realizado v1: En caso que
	 * el bebedor esté referenciado por otra relación, NO SE BORRA NI EL BEBEDOR, NI
	 * SUS VISITAS Adiciona entradas al log de la aplicación
	 * 
	 * @param idBebedor - El bebedor que se quiere eliminar
	 * @return Una pareja de números [número de bebedores eliminados, número de
	 *         visitas eliminadas]
	 */
	...
	/**
	 * Elimina un bebedor y las visitas a bares que haya realizado v2 En caso que el
	 * bebedor esté referenciado por otra relación, EL BEBEDOR NO SE BORRA. PERO SUS
	 * VISITAS SÍ Adiciona entradas al log de la aplicación
	 * 
	 * @param idBebedor - El bebedor que se quiere eliminar
	 * @return Una pareja de números [número de bebedores eliminados, número de
	 *         visitas eliminadas]
	 ...
	 *****************************************************************/
	/**
	 * Adiciona de manera persistente un bar Adiciona entradas al log de la
	 * aplicación
	 * 
	 * @param nombre      - El nombre del bar
	 * @param presupuesto - El presupuesto del bar (ALTO, MEDIO, BAJO)
	 * @param ciudad      - La ciudad del bar
	 * @param sedes       - El número de sedes que tiene el bar en la ciudad (Mayor
	 *                    que 0)
	...
	/**
	 * Elimina un bar por su nombre Adiciona entradas al log de la aplicación
	 * 
	...
	/**
	 * Encuentra todos los bares en Parranderos Adiciona entradas al log de la
	 * aplicación
	 * 
	 * @return Una lista de objetos Bar con todos las bares que conoce la
	 *         aplicación, llenos con su información básica
	 */
	...
	/**
	 * Encuentra todos los bares en Parranderos y los devuelce como VO Adiciona
	 * entradas al log de la aplicación
	 * 
	 * @return Una lista de objetos Bar con todos las bares que conoce la
	 *         aplicación, llenos con su información básica
	...
	/**
	 * Aumenta en 1 el número de sedes de los bares de una ciudad Adiciona entradas
	 * al log de la aplicación
	 * 
	 * @param ciudad - La ciudad en la cual se aumenta el número de sedes de los
	 *               bares
	...
	/**
	 * Encuentra los bares que conoce la aplicación y el número de bebidas que sirve
	 * cada uno, para aquellos bares que sirven por lo menos una bebida Adiciona
	 * entradas al log de la aplicación
	 * 
	...
	/**
	 * Encuentra todos los gustan en Parranderos Adiciona entradas al log de la
	 * aplicación
	 * 
	 * @return Una lista de objetos Gustan con todos los GUSTAN que conoce la
	 *         aplicación, llenos con su información básica
	 */
	...
	/**
	 * Encuentra todos los gustan en Parranderos y los devuelve como VO Adiciona
	 * entradas al log de la aplicación
	 * 
	 * @return Una lista de objetos Gustan con todos los GUSTAN que conoce la
	 *         aplicación, llenos con su información básica
	 ...
	 * @param idBebida - El identificador de la bebida
	 * @param horario  - El horario en el que se sirve la bebida (DIURNO, NOCTURNO,
	 *                 TODOS)
	...
	/**
	 * Encuentra todos los SIRVEN en Parranderos Adiciona entradas al log de la
	 * aplicación
	 * 
	 * @return Una lista de objetos SIRVEN con todos los GUSTAN que conoce la
	 *         aplicación, llenos con su información básica
	 */
	...
	/**
	 * Encuentra todos los sirven en Parranderos y los devuelve como VO Adiciona
	 * entradas al log de la aplicación
	 * 
	 * @return Una lista de objetos SIRVEN con todos los SIRVEN que conoce la
	 *         aplicación, llenos con su información básica
	 */
	...
	/**
	 * Adiciona de manera persistente el hecho que un bebedor visita un bar Adiciona
	 * entradas al log de la aplicación
	 * 
	 * @param idBebedor - El identificador del bebedor
	 * @param idBar     - El identificador del bar
	...
	/**
	 * Elimina de manera persistente el hecho que un bebedor visita un bar Adiciona
	 * entradas al log de la aplicación
	 * 
	 * @param idBebedor - El identificador del bebedor
	 * @param idBar     - El identificador del bar
	...
	/**
	 * Encuentra todos los VISITAN en Parranderos Adiciona entradas al log de la
	 * aplicación
	 * 
	 * @return Una lista de objetos VISITAN con todos los GUSTAN que conoce la
	 *         aplicación, llenos con su información básica
	 */
	...
	/**
	 * Encuentra todos los visitan en Parranderos y los devuelve como VO Adiciona
	 * entradas al log de la aplicación
	 * 
	 * @return Una lista de objetos Visitan con todos los Visitan que conoce la
	 *         aplicación, llenos con su información básica
	 */
