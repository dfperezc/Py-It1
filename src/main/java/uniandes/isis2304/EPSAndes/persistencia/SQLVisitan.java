 ...
 * concepto VISITAN de Parranderos Nótese que es una clase que es sólo conocida
...
class SQLVisitan {
	 ...
	 * @param horario   - EL horario en que se realizó la visita (DIURNO, NOCTURNO,
	 *                  TODOS)
	 * @return EL número de tuplas insertadas
	 */
	public long adicionarVisitan(PersistenceManager pm, long idBebedor, long idBar, Timestamp fecha, String horario) {
		Query q = pm.newQuery(SQL,
				"INSERT INTO " + pp.darTablaVisitan() + "(idbebedor, idbar, fechavisita, horario) values (?, ?, ?, ?)");
		q.setParameters(idBebedor, idBar, fecha, horario);
		return (long) q.executeUnique();
	}

	/**
	 * Crea y ejecuta la sentencia SQL para eliminar TODAS LAS VISITAS de la base de
	...
	/**
	 * Crea y ejecuta la sentencia SQL para eliminar UN VISITAN de la base de datos
	 * de Parranderos, por sus identificadores
	 * 
	 * @param pm        - El manejador de persistencia
	 * @param idBebedor - El identificador del bebedor
	 * @param idBar     - El identificador del bar
	...
	/**
	 * Crea y ejecuta la sentencia SQL para ELIMINAR TODAS LAS VISITAS DE UN BEBEDOR
	...
	/**
	 * Crea y ejecuta la sentencia SQL para ELIMINAR TODAS LAS VISITAS HECHAS A UN
	 * BAR de la base de datos de Parranderos, por su identificador
	 * 
	 * @param pm    - El manejador de persistencia
	 * @param idBar - El identificador del bar
	 * @return EL número de tuplas eliminadas
	...
	/**
	 * Crea y ejecuta la sentencia SQL para encontrar la información de los VISITAN
