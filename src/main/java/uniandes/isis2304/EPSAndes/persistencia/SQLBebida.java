 ...
 * concepto BEBIDA de Parranderos Nótese que es una clase que es sólo conocida
...
class SQLBebida {
	 ...
	 */
	public SQLBebida(EPSAndes pp) {
		this.pp = pp;
	}

	/**
	 * Crea y ejecuta la sentencia SQL para adicionar una BEBIDA a la base de datos
	 * de Parranderos
	 * 
	 ...
	 */
	public long adicionarBebida(PersistenceManager pm, long idBebida, String nombre, long idTipoBebida,
			int gradoAlcohol) {
		Query q = pm.newQuery(SQL,
				"INSERT INTO " + pp.darTablaBebida() + "(id, nombre, idTipoBebida, gradoalcohol) values (?, ?, ?, ?)");
		q.setParameters(idBebida, nombre, idTipoBebida, gradoAlcohol);
		return (long) q.executeUnique();
	}

	/**
	 * Crea y ejecuta la sentencia SQL para eliminar BEBIDAS de la base de datos de
	 * Parranderos, por su nombre
	 * 
	 * @param pm           - El manejador de persistencia
	...
	/**
	 * Crea y ejecuta la sentencia SQL para eliminar BEBIDAS de la base de datos de
	 * Parranderos, por su identificador
	 * 
	 * @param pm       - El manejador de persistencia
	 * @param idBebida - El identificador de la bebida
	 * @return EL número de tuplas eliminadas
	...
	/**
	 * Crea y ejecuta la sentencia SQL para encontrar la información de UNA BEBIDA
	...
	/**
	 * Crea y ejecuta la sentencia SQL para encontrar la información de BEBIDAS de
	 * la base de datos de Parranderos, por su nombre
	 * 
	 * @param pm           - El manejador de persistencia
	 * @param nombreBebida - El nombre de la bebida
	...
	/**
	 * Crea y ejecuta la sentencia SQL para encontrar la información de LAS BEBIDAS
	 * de la base de datos de Parranderos
	 * 
	 * @param pm - El manejador de persistencia
	...
	/**
	 * Crea y ejecuta la sentencia SQL para eliminar LAS BEBIDAS que no son servidas
	 * de la base de datos de Parranderos
	 * 
	 * @param pm - El manejador de persistencia
	 * @return El número de tuplas eliminadas
