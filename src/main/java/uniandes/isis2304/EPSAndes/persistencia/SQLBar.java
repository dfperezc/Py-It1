...
class SQLBar {
	...
	/**
	 * Crea y ejecuta la sentencia SQL para adicionar un BAR a la base de datos de
	 * Parranderos
	 * 
	 ...
	 */
	public long adicionarBar(PersistenceManager pm, long idBar, String nombre, String ciudad, String presupuesto,
			int sedes) {
		Query q = pm.newQuery(SQL, "INSERT INTO " + pp.darTablaBar()
				+ "(id, nombre, ciudad, presupuesto, cantsedes) values (?, ?, ?, ?, ?)");
		q.setParameters(idBar, nombre, ciudad, presupuesto, sedes);
		return (long) q.executeUnique();
	}

	/**
	 * Crea y ejecuta la sentencia SQL para eliminar BARES de la base de datos de
	...
	/**
	 * Crea y ejecuta la sentencia SQL para eliminar UN BAR de la base de datos de
	...
	/**
	 * Crea y ejecuta la sentencia SQL para encontrar la información de LOS BARES de
	...
	/**
	 * Crea y ejecuta la sentencia SQL para encontrar la información de LOS BARES de
	 * la base de datos de Parranderos
	 * 
	 * @param pm - El manejador de persistencia
	...
	/**
	 * Crea y ejecuta la sentencia SQL para aumentar en uno el número de sedes de
	 * los bares de la base de datos de Parranderos
	 * 
	 * @param pm     - El manejador de persistencia
