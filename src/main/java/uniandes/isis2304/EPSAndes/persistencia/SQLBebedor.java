 ...
 * concepto BEBEDOR de Parranderos Nótese que es una clase que es sólo conocida
...
class SQLBebedor {
	 ...
	 */
	public SQLBebedor(PersistenciaEPSAndes pp) {
		this.pp = pp;
	}

	/**
	 * Crea y ejecuta la sentencia SQL para adicionar un BEBEDOR a la base de datos
	 * de Parranderos
	 * 
	 ...
	 */
	public long adicionarBebedor(PersistenceManager pm, long idBebedor, String nombre, String ciudad,
			String presupuesto) {
		Query q = pm.newQuery(SQL,
				"INSERT INTO " + pp.darTablaBebedor() + "(id, nombre, ciudad, presupuesto) values (?, ?, ?, ?)");
		q.setParameters(idBebedor, nombre, ciudad, presupuesto);
		return (long) q.executeUnique();
	}

	/**
	 * Crea y ejecuta la sentencia SQL para eliminar BEBEDORES de la base de datos
	 * de Parranderos, por su nombre
	 * 
	 * @param pm     - El manejador de persistencia
	 * @param nombre - El nombre del bebedor
	...
	/**
	 * Crea y ejecuta la sentencia SQL para eliminar UN BEBEDOR de la base de datos
	 * de Parranderos, por su identificador
	 * 
	 * @param pm        - El manejador de persistencia
	...
	/**
	 * Crea y ejecuta la sentencia SQL para encontrar la información de UN BEBEDOR
	 * de la base de datos de Parranderos, por su identificador
	 * 
	 * @param pm        - El manejador de persistencia
	 * @param idBebedor - El identificador del bebedor
	 ...
	 * BEBEDORES de la base de datos de Parranderos, por su nombre
	 * 
	 * @param pm            - El manejador de persistencia
	...
	/**
	 * Crea y ejecuta la sentencia SQL para encontrar la información de LOS
	 * BEBEDORES de la base de datos de Parranderos
	 * 
	 * @param pm - El manejador de persistencia
	...
	/**
	 * Crea y ejecuta la sentencia SQL para encontrar la información de LOS
	 * BEBEDORES Y DE SUS VISITAS REALIZADAS de la base de datos de Parranderos
	 * 
	 * @param pm        - El manejador de persistencia
	 * @param idBebedor - El identificador del bebedor
	 * @return Una lista de arreglos de objetos, de tamaño 7. Los elementos del
	 *         arreglo corresponden a los datos de los bares visitados y los datos
	 *         propios de la visita: (id, nombre, ciudad, presupuesto, cantsedes) de
	 *         los bares y (fechavisita, horario) de las visitas
	 */
	...
	/**
	 * Crea y ejecuta la sentencia SQL para encontrar la información de LOS
	 * BEBEDORES Y DE LAS BEBIDAS QUE GUSTA de la base de datos de Parranderos
	 * 
	 * @param pm        - El manejador de persistencia
	 * @param idBebedor - El identificador del bebedor
	 * @return Una lista de arreglos de objetos, de tamaño 5. Los elementos del
	 *         arreglo corresponden a los datos de las bebidas (con el nombre del
	 *         tipo de bebida) que le gustan al bebedor: (id, nombre, idtipobebida,
	 *         gradoalcohol) de la bebida y el (nombre) del tipo de bebida
	 */
	...
	/**
	 * Crea y ejecuta la sentencia SQL para encontrar la información de LOS
	 * BEBEDORES Y DE CUÁNTAS VISITAS HA REALIZADO de la base de datos de
	 * Parranderos. Incluye, con 0, los bebedores que no han realizado visitas
	 * 
	 * @param pm - El manejador de persistencia
	 * @return Una lista de arreglos de objetos, de tamaño 5. Los elementos del
	 *         arreglo corresponden a los datos del bebedor, y del número de visitas
	 *         realizadas: (id, nombre, ciudad, presupuesto) del bebedor y
	 *         numVisitas
	 */
	...
	/**
	 * Crea y ejecuta la sentencia SQL para encontrar la cantidad de BEBEDORES de
	 * una ciudad que visitan bares de la base de datos de Parranderos
	 * 
	 * @param pm     - El manejador de persistencia
	...
	/**
	 * Crea y ejecuta la sentencia SQL para: Eliminar un bebedor y las visitas a
	 * bares que haya realizado v1: En caso que el bebedor esté referenciado por
	 * otra relación, NO SE BORRA NI EL BEBEDOR, NI SUS VISITAS Adiciona entradas al
	...
	/*
	 * **************************************************************** Métodos de
	 * prueba para subtransacciones
	 *****************************************************************/
	// ****************** QUITAR EN LA VERSIÓN A ENTREGAR
	/**
	 * Crea y ejecuta la sentencia SQL para encontrar la información de LOS
	 * BEBEDORES Y DE CUÁNTOS BARES VISITAN de la base de datos de Parranderos.
	 * Incluye, con 0, los bebedores que no han realizado visitas
	 * 
	 * @param pm - El manejador de persistencia
	 * @return Una lista de arreglos de objetos, de tamaño 5. Los elementos del
	 *         arreglo corresponden a los datos del bebedor, y del número de bares
	 *         que visita: (id, nombre, ciudad, presupuesto) del bebedor y numbares
	 */
	public List<Object> darBebedoresYCuantosBaresVisitan(PersistenceManager pm) {
		...
		// Agrupa las parejas anteriores por idBebedor y cuenta cuántos bares visita
		// cada bebedor
		String sql1 = "SELECT idbebedor, count (*) as numbares";
		sql1 += " FROM " + "(" + sql0 + ")";
		sql1 += " GROUP BY idBebedor";

		// Hace join de BEBEDORES con el resultado anterior para asociar la información
		// del bebedor
